---
title: Development
description: Learn how to develop and contribute to the Lando Lagoon service
---

# Development

This guide contains information to help onboard developers to work on the [lagoon](https://lagoon.microsoft.com/en-us/) integration, hereafter referred to as *the plugin*.
...
```sh
# Clone this repo
git clone https://github.com/lando/lagoon.git && cd lagoon
...
This plugin contains various working and tested Lando apps in the [examples](https://github.com/lando/lagoon/tree/main/examples) folder. You should use these or create new ones to help with plugin development.
...
This tells Lando that _this_ app should use the source version of the `@lando/lagoon` plugin you cloned down in the installation. This is useful because it allows you to isolate development within this repo without interferring with any other apps using the stable and global version of the plugin.
...
If you check out the various READMEs in our [examples](https://github.com/lando/lagoon/tree/main/examples) you will notice that they are all Leia tests.
...
npm install @lando/lagoon
# Will pull the most recent GitHub pre-release
npm install @lando/lagoon@edge
```
