...
const getLandoServiceType = type => {
  switch (type) {
    case 'basic': return 'lagoon-basic';
...
exports.getLandoAuxServices = (services = {}, config) => {
  ...
  if (!_.isEmpty(getServicesByType(services, 'lagoon-php'))) {
    services.mailhog = {type: 'lagoon-mailhog:v1.0.0', hogfrom: getServicesByType(services, 'lagoon-php')};
  }
  // Add in lagoon CLI
