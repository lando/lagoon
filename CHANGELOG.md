## v1.0.0 - [January 1st, 2024](https://github.com/lando/lagoon/releases/tag/v1.0.0)
  ...
  * Added custom lagoon-sql-export/import.sh scripts to fix issues with mariadb import/export.
